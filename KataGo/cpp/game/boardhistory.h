...
struct BoardHistory {
  ...
  //If preserveScytheState is true, scythe counts and combo state are NOT reset
  void clear(const Board& board, Player pla, const Rules& rules, int encorePhase, bool preserveScytheState = false);
