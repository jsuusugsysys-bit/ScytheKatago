...
struct Board
{
  ...
  //Location used to indicate a scythe trigger (virtual move for search tree)
  static constexpr Loc SCYTHE_TRIGGER_LOC = 2;

  // --- Scythe Constants ---
  static constexpr int SCYTHE_MIN_MOVE = 11;
  static constexpr int SCYTHE_MAX_MOVE = 49;

  // Check if a location represents a scythe trigger move
  static inline bool isScytheMove(Loc loc) {
    return loc == SCYTHE_TRIGGER_LOC;
  }
