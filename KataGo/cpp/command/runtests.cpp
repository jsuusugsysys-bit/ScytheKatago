...
int MainCmds::runtests(const vector<string>& args) {
  ...
  Tests::runScytheTests();  // Scythe (镰刀) functionality tests
  Tests::runScytheSearchTests();  // Scythe search tree tests
  Tests::runScytheNodeTests();  // Scythe virtual node tests (Phase 3)
  Tests::runScytheTriggerTests();  // Scythe trigger integration tests (Phase 4)
  Tests::runScytheSearchIntegrationTests();  // Scythe search integration tests (Phase 5)
  Tests::runScytheGTPTests();  // Scythe GTP output tests (Phase 6)
