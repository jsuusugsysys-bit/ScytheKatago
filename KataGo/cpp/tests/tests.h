...
namespace Tests {
  ...
  //testscythe.cpp
  void runScytheTests();
  void runScytheSearchTests();
  void runScytheNodeTests();
  void runScytheTriggerTests();
  void runScytheSearchIntegrationTests();
  void runScytheGTPTests();

  //testscythe_search.cpp
  void runScytheSearchTriggerStateTest();
  void runScytheSearchConsecutiveMovesTest();
  void runScytheSearchPlayerSwitchTest();
}
